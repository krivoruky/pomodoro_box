...
export function TimeOnPauseIcon() {
    return (
        <svg width="129" height="129" viewBox="0 0 129 129" fill="none"
            ...
            <path
                ...
                stroke="#C4C4C4" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M64.3154 37.1579V64.3158L77.8944 77.8947" stroke="#C4C4C4" strokeWidth="5"
